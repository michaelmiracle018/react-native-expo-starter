...
const QuickTradeSelector = React.forwardRef<
    ...
    return (
      <BottomSheet>
        ...
        >
          <View
            className={cn(
              "flex-row h-14 border border-info items-center rounded-md bg-background px-2",
              headerClass,
            )}
          >
            <View>
              {itemSelected ? (
                <Text
                  className={cn("text-primary text-xl font-bold", textClass)}
                  numberOfLines={1}
                >
