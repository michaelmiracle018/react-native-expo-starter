...
const MarketSelector = React.forwardRef<
      ...
      <BottomSheet>
        ...
        >
          <View className="flex-center flex-row gap-1">
            {/* <Text className="font-bold text-lg ">{tradeType}</Text> */}
            <View
              className={cn(
                "flex-row justify-between h-12 items-center rounded-md px-1 bg-stone-200",
                headerClass,
              )}
            >
              <View className="flex-row gap-1">
                <Text
                  className={cn("text-primary text-lg font-regular", textClass)}
                  numberOfLines={1}
                >
                  {itemSelected?.flag}
                </Text>
              ...
              <ChevronDown
                className="text-foreground ml-2 font-bold"
                // size={20}
              />
            </View>
          </View>
